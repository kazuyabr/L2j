...
public class CellPathFinding extends PathFinding
{
	...
	protected CellPathFinding()
	{
		try
		{
			...
			_log.info("CellPathFinding: buffers have been loaded.");
		}
		catch (Exception e)
		{
			_log.log(Level.WARNING, "CellPathFinding: Problem during buffer init: " + e.getMessage(), e);
			throw new Error("CellPathFinding: loading have been aborted.");
		}
	}
	...
	private static List<AbstractNodeLoc> constructPath(AbstractNode node)
	{
