 ...
 * Updated by Eduardo da Silva Souza (@edusz93)
 */
public class Frintezza extends L2AttackableAIScript
{
    ...
    {
        addEventIds(NPCS, ScriptEventType.ON_ATTACK, ScriptEventType.ON_KILL, ScriptEventType.ON_SKILL_SEE);
    }
    ...
    public String onAdvEvent(String event, Npc npc, Player player)
    {
        if (event.equalsIgnoreCase("beginning"))
        {
            ...
            ZONE.broadcastPacket(new CreatureSay(0, Say2.SHOUT, "Hall Alarm Device", "Intruders! Sound the alarm!"));
        ...
        else if (event.equalsIgnoreCase("notice"))
        {
            if (_notice == 0)
            {
                ZONE.broadcastPacket(new CreatureSay(0, Say2.SHOUT, "Frintezza Gatekeeper", "Time limit exceeded, challenge failed!"));
                ZONE.oustAllPlayers();
        ...
        {
            startQuestTimer("close", 27000, null, null, false);
        ...
        else if (event.equalsIgnoreCase("camera_1"))
        {
            ...
            stopPcActions();
            startQuestTimer("camera_2", 1000, dummy, null, false);
        }
        else if (event.equalsIgnoreCase("camera_2"))
        {
            ...
            startQuestTimer("camera_4", 6500, npc, null, false);
        }
        else if (event.equalsIgnoreCase("camera_4"))
        {
            ...
            startQuestTimer("camera_5", 900, dummy, null, false);
        }
        else if (event.equalsIgnoreCase("camera_5"))
        {
            ZONE.broadcastPacket(new SpecialCamera(npc.getObjectId(), 140, 90, 10, 2500, 4500));
            startQuestTimer("camera_5b", 4000, npc, null, false);
        }
        else if (event.equalsIgnoreCase("camera_5b"))
        {
            ...
            startQuestTimer("camera_7", 1350, npc, null, false);
        }
        else if (event.equalsIgnoreCase("camera_7"))
        {
            ZONE.broadcastPacket(new SocialAction(_frintezza, 2));
            startQuestTimer("camera_8", 7000, npc, null, false);
        }
        else if (event.equalsIgnoreCase("camera_8"))
        {
            npc.deleteMe();
            startQuestTimer("camera_9", 1000, null, null, false);
        }
        else if (event.equalsIgnoreCase("camera_9"))
        {
            ...
            startQuestTimer("camera_9b", 400, null, null, false);
        }
        else if (event.equalsIgnoreCase("camera_9b"))
        {
            ...
            startQuestTimer("camera_10", 2000, null, null, false);
        }
        ...
        else if (event.equalsIgnoreCase("camera_14"))
        {
            ...
            startQuestTimer("camera_16", 1500, null, null, false);
        }
        else if (event.equalsIgnoreCase("camera_16"))
        {
            ...
            startQuestTimer("camera_17", 7500, null, null, false);
        }
        else if (event.equalsIgnoreCase("camera_17"))
        {
            ...
            startQuestTimer("camera_18", 9500, null, null, false);
        }
        else if (event.equalsIgnoreCase("camera_18"))
        {
            ...
            startQuestTimer("camera_19", 5500, npc, null, false);
            startQuestTimer("camera_19b", 5400, npc, null, false);
        }
        else if (event.equalsIgnoreCase("camera_19"))
        {
            ZONE.broadcastPacket(new SpecialCamera(npc.getObjectId(), 800, 160, 5, 1000, 10000));
            startQuestTimer("camera_20", 2100, npc, null, false);
        }
        ...
        else if (event.equalsIgnoreCase("camera_22"))
        {
            ...
            startQuestTimer("camera_23", 2000, npc, null, false);
            startQuestTimer("songs_play", 10000 + Rnd.get(10000), npc, null, false);
            startQuestTimer("skill_ai", 10000 + Rnd.get(10000), npc, null, false);
        }
        ...
        else if (event.equalsIgnoreCase("songs_play"))
        {
            if (npc.isCastingNow() || _currentSong != 0)
                startQuestTimer("songs_play", 5000 + Rnd.get(5000), npc, null, false);
            else if (_frintezza != null && !_frintezza.isDead())
            {
                ...
                if (_currentSong == 1 && _transformed == 2 && npc.getCurrentHp() < npc.getMaxHp() * 0.6 && Rnd.get(100) < 80)
                {
                    ...
                    startQuestTimer("songs_effect", 4000, null, null, false);
                    startQuestTimer("songs_play", 32000 + Rnd.get(10000), npc, null, false);
                }
                else if (_currentSong == 2 || _currentSong == 3)
                {
                    ...
                    startQuestTimer("songs_effect", 5000, null, null, false);
                    startQuestTimer("songs_play", 32000 + Rnd.get(10000), npc, null, false);
                }
                else if (_currentSong == 4 && _currentSong == 1)
                {
                    ...
                    startQuestTimer("songs_effect", 5000, null, null, false);
                    startQuestTimer("songs_play", 31000 + Rnd.get(10000), npc, null, false);
                }
                else if (_currentSong == 5 && _transformed == 2)
                {
                    ZONE.broadcastPacket(new MagicSkillUse(_frintezza, _frintezza, 5007, 5, 35000, 0));
                    startQuestTimer("songs_effect", 5000, null, null, false);
                    startQuestTimer("songs_play", 35000 + Rnd.get(10000), npc, null, false);
                }
                else
                {
                    ZONE.broadcastPacket(new MagicSkillUse(_frintezza, _frintezza, 5006, 1, 34000, 0));
        ...
        else if (event.equalsIgnoreCase("songs_effect"))
        {
            if (_currentSong > 0)
            {
                ...
                else if (_currentSong == 5)
                {
                    ...
                    startQuestTimer("stop_effect", 25000, null, null, false);
                }
            }
        }
        ...
        else if (event.equalsIgnoreCase("skill_ai"))
        {
            if (!npc.isDead())
            {
                ...
                else if (_transformed == 1)
                {
                    ...
                    if (i == 5)
                        startQuestTimer("float_effect", 4000, npc, null, false);
                }
                else
                {
                    int i = Rnd.get(6, 10);
                ...
                startQuestTimer("skill_ai", 15000 + Rnd.get(10000), npc, null, false);
            }
        }
        ...
        else if (event.equalsIgnoreCase("morph_01"))
        {
            ...
            startQuestTimer("morph_02", 3000, npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_02"))
        {
            ZONE.broadcastPacket(new SocialAction(npc, 1));
            startQuestTimer("morph_04", 5500, npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_04"))
        {
            ...
            startQuestTimer("start_pc", 3000, null, null, false);
            startQuestTimer("start_npc", 3000, null, null, false);
        }
        else if (event.equalsIgnoreCase("morph_05a"))
        {
            ZONE.broadcastPacket(new SocialAction(_frintezza, 4));
            startQuestTimer("morph_05", 100, npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_05"))
        {
            ...
            startQuestTimer("morph_07", 7000, npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_07"))
        {
            ...
            startQuestTimer("morph_08", 3000, npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_08"))
        {
            ...
            startQuestTimer("morph_09", 3000, npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_09"))
        {
            ...
            startQuestTimer("morph_11", 500, npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_11"))
        {
            ...
            startQuestTimer("morph_12", 6250, npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_12"))
        {
            npc.deleteMe();
            startQuestTimer("morph_13", 950, npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_13"))
        {
            ...
            startQuestTimer("morph_15", 8100, npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_15"))
        {
            ...
            startQuestTimer("start_pc", 6000, null, null, false);
            startQuestTimer("start_npc", 6000, null, null, false);
            startQuestTimer("songs_play", 10000 + Rnd.get(10000), npc, null, false);
            startQuestTimer("skill_ai", 10000 + Rnd.get(10000), npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_17b"))
        {
            ...
            startQuestTimer("morph_18", 100,npc, null, false);
        }
        else if (event.equalsIgnoreCase("morph_18"))
        {
            ...
            startQuestTimer("morph_20", 7000, npc, null, false);
        }
    ...
    public String onKill(Npc npc, Creature killer)
    {
        ...
        else if (npc.getNpcId() == 18328)
        {
            ...
            {
                ZONE.broadcastPacket(new CreatureSay(npc.getObjectId(), Say2.SHOUT, npc.getName(), "De-activate the alarm."));
                deleteAllMobs();
                room2Spawn(1);
            }
        }
