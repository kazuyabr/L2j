			...
			case 32011:
				...
				if (st.hasQuestItems(8073))
				{
					...
					if (status == Frintezza.DORMANT)
					{
						...
						ScriptData.getInstance().getQuest("Frintezza").startQuestTimer("close", 100, null, null, false);
						ScriptData.getInstance().getQuest("Frintezza").startQuestTimer("beginning", 5000, null, null, false);
						ScriptData.getInstance().getQuest("Frintezza").startQuestTimer("notice", 2100000, null, null, false);
						ScriptData.getInstance().getQuest("Frintezza").startQuestTimer("frintezza_despawn", 60000, null, null, false);
					}
