					...
					if (val.equalsIgnoreCase("recovery"))
					{
						if (st.countTokens() >= 1)
						{
							...
							else if (val.equalsIgnoreCase("edit_hp"))
							{
								...
								html.replace("%cost%", String.valueOf(cost) + "</font> adenas / " + String.valueOf(Config.CH_HPREG_FEE_RATIO / 86400000) + " day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_mp"))
							{
								...
								html.replace("%cost%", String.valueOf(cost) + "</font> adenas / " + String.valueOf(Config.CH_MPREG_FEE_RATIO / 86400000) + " day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_exp"))
							{
								...
								html.replace("%cost%", String.valueOf(cost) + "</font> adenas / " + String.valueOf(Config.CH_EXPREG_FEE_RATIO / 86400000) + " day</font>)");
						...
						if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP) != null)
						{
							html.replace("%hp_recovery%", String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP).getLvl()) + "%</font> (<font color=\"FFAABB\">" + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP).getLease()) + "</font> adenas / " + String.valueOf(Config.CH_HPREG_FEE_RATIO / 86400000) + " day)");
						...
						if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_EXP) != null)
						{
							html.replace("%exp_recovery%", String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_EXP).getLvl()) + "%</font> (<font color=\"FFAABB\">" + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_EXP).getLease()) + "</font> adenas / " + String.valueOf(Config.CH_EXPREG_FEE_RATIO / 86400000) + " day)");
						...
						if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_MP) != null)
						{
							html.replace("%mp_recovery%", String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_MP).getLvl()) + "%</font> (<font color=\"FFAABB\">" + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_RESTORE_MP).getLease()) + "</font> adenas / " + String.valueOf(Config.CH_MPREG_FEE_RATIO / 86400000) + " day)");
					...
					else if (val.equalsIgnoreCase("other"))
					{
						if (st.countTokens() >= 1)
						{
							...
							else if (val.equalsIgnoreCase("edit_item"))
							{
								...
								html.replace("%cost%", String.valueOf(cost) + "</font> adenas / " + String.valueOf(Config.CH_ITEM_FEE_RATIO / 86400000) + " day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_support"))
							{
								...
								html.replace("%cost%", String.valueOf(cost) + "</font> adenas / " + String.valueOf(Config.CH_SUPPORT_FEE_RATIO / 86400000) + " day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_tele"))
							{
								...
								html.replace("%cost%", String.valueOf(cost) + "</font> adenas / " + String.valueOf(Config.CH_TELE_FEE_RATIO / 86400000) + " day</font>)");
						...
						if (getClanHall().getFunction(ClanHall.FUNC_TELEPORT) != null)
						{
							html.replace("%tele%", "- Stage " + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl()) + "</font> (<font color=\"FFAABB\">" + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLease()) + "</font> adenas / " + String.valueOf(Config.CH_TELE_FEE_RATIO / 86400000) + " day)");
						...
						if (getClanHall().getFunction(ClanHall.FUNC_SUPPORT) != null)
						{
							html.replace("%support%", "- Stage " + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl()) + "</font> (<font color=\"FFAABB\">" + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLease()) + "</font> adenas / " + String.valueOf(Config.CH_SUPPORT_FEE_RATIO / 86400000) + " day)");
						...
						if (getClanHall().getFunction(ClanHall.FUNC_ITEM_CREATE) != null)
						{
							html.replace("%item%", "- Stage " + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_ITEM_CREATE).getLvl()) + "</font> (<font color=\"FFAABB\">" + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_ITEM_CREATE).getLease()) + "</font> adenas / " + String.valueOf(Config.CH_ITEM_FEE_RATIO / 86400000) + " day)");
					...
					else if (val.equalsIgnoreCase("deco"))
					{
						if (st.countTokens() >= 1)
						{
							...
							else if (val.equalsIgnoreCase("edit_curtains"))
							{
								...
								html.replace("%cost%", String.valueOf(cost) + "</font> adenas / " + String.valueOf(Config.CH_CURTAIN_FEE_RATIO / 86400000) + " day</font>)");
							...
							else if (val.equalsIgnoreCase("edit_fixtures"))
							{
								...
								html.replace("%cost%", String.valueOf(cost) + "</font> adenas / " + String.valueOf(Config.CH_FRONT_FEE_RATIO / 86400000) + " day</font>)");
						...
						if (getClanHall().getFunction(ClanHall.FUNC_DECO_CURTAINS) != null)
						{
							html.replace("%curtain%", "- Stage " + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_DECO_CURTAINS).getLvl()) + "</font> (<font color=\"FFAABB\">" + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_DECO_CURTAINS).getLease()) + "</font> adenas / " + String.valueOf(Config.CH_CURTAIN_FEE_RATIO / 86400000) + " day)");
						...
						if (getClanHall().getFunction(ClanHall.FUNC_DECO_FRONTPLATEFORM) != null)
						{
							html.replace("%fixture%", "- Stage " + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_DECO_FRONTPLATEFORM).getLvl()) + "</font> (<font color=\"FFAABB\">" + String.valueOf(getClanHall().getFunction(ClanHall.FUNC_DECO_FRONTPLATEFORM).getLease()) + "</font> adenas / " + String.valueOf(Config.CH_FRONT_FEE_RATIO / 86400000) + " day)");
