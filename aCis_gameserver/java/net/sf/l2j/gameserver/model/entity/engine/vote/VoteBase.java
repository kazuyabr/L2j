package net.sf.l2j.gameserver.model.entity.engine.vote;
...
{
	private static final CLogger LOGGER = new CLogger(VoteBase.class.getName());
	...
	public void updateDB(Player player, String columnName)
	{
		...
		{
			LOGGER.info("Error in VoteBase::updateDB");
		}
	}
	...
	public String getApiResponse(String endpoint)
	{
		...
		{
			LOGGER.info("Something went wrong in VoteBase::getApiResponse");
			return "err";
		}
	}
}