...
public class Q422_RepentYourSins extends Quest
{
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		switch (npc.getNpcId())
		{
			case 20039:
				if (st.getInt("cond") == 6)
					st.dropItemsAlways(SCAVENGER_WERERAT_SKULL, 1, 10);
				break;
			
			case 20494:
				if (st.getInt("cond") == 7)
					st.dropItemsAlways(TUREK_WARHOUND_TAIL, 1, 10);
				break;
			...
			case 20561:
				if (st.getInt("cond") == 9)
					st.dropItemsAlways(TRISALIM_TARANTULAS_VENOM_SAC, 1, 3);
				break;
		}
